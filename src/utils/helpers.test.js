...
describe('Helpers', () => {
    ...
    describe('Slot Availability', () => {
        ...
        describe('Duration-based blocking', () => {
            const services = [
                { id: 'svc60', duration: 60 },
                { id: 'svc30', duration: 30 },
            ]
            ...
            it('should block 15:30 when 60min service is booked at 15:00', () => {
                const result = isSlotAvailable('15:30', longAppointments, 'barber1', '2023-10-10', 30, services)
                expect(result).toBe(false)
            })

            it('should allow 16:00 when 60min service is booked at 15:00', () => {
                const result = isSlotAvailable('16:00', longAppointments, 'barber1', '2023-10-10', 30, services)
                expect(result).toBe(true)
            })

            it('should block when new long service overlaps existing appointment', () => {
                const result = isSlotAvailable('14:30', longAppointments, 'barber1', '2023-10-10', 60, services)
                expect(result).toBe(false)
            })

            it('should allow when new long service does not overlap', () => {
                const result = isSlotAvailable('16:00', longAppointments, 'barber1', '2023-10-10', 60, services)
                expect(result).toBe(true)
            })
        })
    })
